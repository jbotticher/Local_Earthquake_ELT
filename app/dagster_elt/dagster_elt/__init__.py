...
from dagster_elt.schedules import earthquake_pipeline_schedule, dbt_earthquake_job_schedule
...
defs = Definitions(
    ...
    schedules=[earthquake_pipeline_schedule, dbt_earthquake_job_schedule],
    resources={
